...
import 'package:justfood_multivendor/common/widgets/product_shimmer_widget.dart';
import 'package:justfood_multivendor/common/widgets/product_widget.dart';
import 'package:justfood_multivendor/features/home/widgets/theme1/restaurant_widget.dart';
...
import 'package:justfood_multivendor/common/widgets/web_restaurant_widget.dart';
...
//             height: ResponsiveHelper.isDesktop(context) && !isWebRestaurant!
//                 ? 300
//                 : ResponsiveHelper.isMobile(context)
//                 ? 200
//                 : 280,
//             viewportFraction: 1/3, // Adjust based on UI requirements
...
class ProductViewWidget2 extends StatelessWidget {
  final List<Product?>? products;
  final List<Restaurant?>? restaurants;
  final bool isRestaurant;
  final EdgeInsetsGeometry padding;
  ...
  final bool? fromFavorite;
  final bool? fromSearch;
  const ProductViewWidget2({super.key, required this.restaurants, required this.products, required this.isRestaurant, this.isScrollable = false,
