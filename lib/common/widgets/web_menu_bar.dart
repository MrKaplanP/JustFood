...
import 'package:justfood_multivendor/common/widgets/hover_widgets/text_hover_widget.dart';
          ...
          child: Center(child: SizedBox(width: Dimensions.webMaxWidth, child: Row(children: [
            InkWell(
              ...
              child: Row(children: [
                ...
                (Get.isDarkMode) ? Image.asset(Images.logoNameDarkMode, height: 30, width: 100) : Image.asset(Images.logoName, height: 30, width: 100),
              ]),
            ),
