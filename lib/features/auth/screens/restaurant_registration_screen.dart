...
import 'package:justfood_multivendor/common/widgets/confirmation_dialog_widget.dart';
import 'package:justfood_multivendor/common/widgets/custom_tool_tip.dart';
import 'package:justfood_multivendor/common/widgets/validate_check.dart';
import 'package:justfood_multivendor/features/auth/domain/models/restaurant_body_model.dart';
import 'package:justfood_multivendor/features/auth/domain/models/translation_body_model.dart';
import 'package:justfood_multivendor/features/auth/widgets/cuisine_widget.dart';
...
import 'package:justfood_multivendor/features/auth/controllers/deliveryman_registration_controller.dart';
import 'package:justfood_multivendor/features/auth/controllers/restaurant_registration_controller.dart';
import 'package:justfood_multivendor/features/auth/widgets/custom_time_picker_widget.dart';
import 'package:justfood_multivendor/features/auth/widgets/pass_view_widget.dart';
import 'package:justfood_multivendor/features/auth/widgets/registration_stepper_widget.dart';
import 'package:justfood_multivendor/features/auth/widgets/restaurant_additional_data_section_widget.dart';
import 'package:justfood_multivendor/features/auth/widgets/select_location_view_widget.dart';
...
import 'package:justfood_multivendor/common/widgets/custom_app_bar_widget.dart';
import 'package:justfood_multivendor/common/widgets/custom_button_widget.dart';
import 'package:justfood_multivendor/common/widgets/custom_snackbar_widget.dart';
import 'package:justfood_multivendor/common/widgets/custom_text_field_widget.dart';
...
import 'package:justfood_multivendor/common/widgets/web_page_title_widget.dart';
                    ...
                    ClipRRect(
                      ...
                      child: restaurantRegistrationController.pickedLogo != null ? GetPlatform.isWeb ? Image.network(
                        ...
                        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                          ...
                          Text('upload_store_logo'.tr, textAlign: TextAlign.center, style: robotoRegular.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeExtraSmall)),
                          const SizedBox(height: Dimensions.paddingSizeExtraSmall),
        ...
        children: [
          ...
          CustomButtonWidget(
            ...
            onPressed: (restaurantRegiController.storeStatus == 0.1 && !ResponsiveHelper.isDesktop(context) && !restaurantRegiController.inZone)
              ...
              print('----------------STORE STATUS: ${restaurantRegiController.storeStatus}--------------------------');
