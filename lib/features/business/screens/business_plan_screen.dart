...
import 'package:justfood_multivendor/features/business/widgets/payment_cart_widget.dart';
import 'package:justfood_multivendor/features/splash/controllers/splash_controller.dart';
import 'package:justfood_multivendor/features/business/controllers/business_controller.dart';
import 'package:justfood_multivendor/features/business/domain/models/package_model.dart';
import 'package:justfood_multivendor/features/business/widgets/base_card_widget.dart';
import 'package:justfood_multivendor/features/business/widgets/business_payment_method_bottom_sheet_widget.dart';
import 'package:justfood_multivendor/features/business/widgets/subscription_card_widget.dart';
import 'package:justfood_multivendor/features/business/widgets/success_widget.dart';
import 'package:justfood_multivendor/helper/color_coverter.dart';
...
class _BusinessPlanScreenState extends State<BusinessPlanScreen> {
  ...
  void initState() {
    ...
    print('-------------------BUSINESS PLAN INIT----------------');
    Get.find<BusinessController>().resetBusiness();
    Get.find<BusinessController>().getPackageList(isUpdate: false).then((_) {
      setState(() {
        _isLoading = false;
      });
    });
  ...
  Widget build(BuildContext context) {
    ...
    print('-------------------BUSINESS PLAN BUILDER----------------');
    return _isLoading ? const Center(child: CircularProgressIndicator()) : GetBuilder<BusinessController>(
