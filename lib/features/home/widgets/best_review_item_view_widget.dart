...
//       return (reviewController.reviewedProductList != null && reviewController.reviewedProductList!.isEmpty)
//           ? const SizedBox()
//           : Padding(
...
//                    autoPlay: true,
//                    // enableInfiniteScroll: reviewController.reviewedProductList!.length > 1, // Disable infinite scroll if only one item
//                     viewportFraction: ResponsiveHelper.isDesktop(context) ? 0.25 : 0.53, // Adjust the number of items visible based on device
