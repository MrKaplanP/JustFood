...
import 'package:justfood_multivendor/features/home/widgets/icon_with_text_row_widget.dart';
    ...
    return SizedBox(
      ...
      child: restaurants != null
        ...
        options: CarouselOptions(
          height: 230, // Height of each restaurant card
          viewportFraction: ResponsiveHelper.isMobile(context)
              ? 0.9
              : ResponsiveHelper.isTab(context)
              ? 0.45
              : 0.23, // Adjust based on device type
        ...
        child: Padding(
          ...
          : CarouselSlider.builder(
        options: CarouselOptions(
          height: 230, // Height of shimmer cards
          viewportFraction: ResponsiveHelper.isMobile(context)
              ? 0.9
              : ResponsiveHelper.isTab(context)
              ? 0.45
        ...
        itemCount: 12, // Shimmer length for loading state
        itemBuilder: (context, index, realIndex) {
          return Padding(
            padding: EdgeInsets.symmetric(
                horizontal: !ResponsiveHelper.isDesktop(context)
        ...
        child: Stack(
          ...
          children: [
            ...
            !isAvailable ? Positioned(top: 10, left: 10, child: Container(
              ...
              child: Row(children: [
                Icon(Icons.access_time, size: 7, color: Theme.of(context).cardColor),
                ...
                Text(
                  ...
                  style: robotoMedium.copyWith(color: Theme.of(context).cardColor, fontSize: 9.0),
                ),
              ]),
            )) : const SizedBox(),
