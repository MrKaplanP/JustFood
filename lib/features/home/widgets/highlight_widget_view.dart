...
import 'package:justfood_multivendor/features/home/domain/models/advertisement_model.dart';
...
class HighlightRestaurantWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      margin: GetPlatform.isMobile ? const EdgeInsets.symmetric(vertical: 10, horizontal: 5) : const EdgeInsets.symmetric(vertical: 10, horizontal: 20),
      height: 280,
      ...
      child: InkWell(
        ...
        child: Column(children: [
              ...
              child: Stack(
                children: [
                  CustomImageWidget(
                    ...
                    fit: BoxFit.cover, height: GetPlatform.isDesktop ? 160 : 110, width: double.infinity,
                  ),
          ...
          (GetPlatform.isDesktop) ? Expanded(
            flex: 3,
            child: Padding(
