                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              ...
                              style: robotoMedium.copyWith(fontWeight: FontWeight.w600, fontSize: 14.0),
                            ),
                            ...
                            Wrap(
                              spacing: isNewOnStackFood! ? Dimensions.paddingSizeExtraSmall : Dimensions.paddingSizeSmall,
                              ...
                              children: [
                                ...
                                if (isNewOnStackFood!)
                                  if (restaurant.freeDelivery!)
                                    ImageWithTextRowWidget(
                                      ...
                                      spacing: Dimensions.newOnStackFoodSpacing,
                                    )
                                  else
                                    SizedBox.shrink()
                                else
                                ...
                                else if (restaurant.freeDelivery!)
                                  ImageWithTextRowWidget(
                                    widget: Image.asset(Images.deliveryIcon, height: 20, width: 20),
                                    text: 'free'.tr,
                                    style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall),
