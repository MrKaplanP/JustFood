...
//                   ),
//                   // Show arrow only for mobile and tablet
...
//           ),
//           SizedBox(
//             height: ResponsiveHelper.isMobile(context) ? 150 : 150,
//             child: categoryController.categoryList != null && categoryController.categoryList!.isNotEmpty
//                 ? CarouselSlider.builder(
//               itemCount: categoryController.categoryList!.length, // No limit on number of categories
//               options: CarouselOptions(
//                 autoPlay: true,
//                 enlargeCenterPage: false,
//                 height: ResponsiveHelper.isMobile(context) ? 150 : 150,
//                 viewportFraction: ResponsiveHelper.isMobile(context) ? 1 / 5 : 1 / 9,
...
//           ),
//
//           // Show the forward arrow only on desktop
//           // if (ResponsiveHelper.isDesktop(context))
//           //   Padding(
