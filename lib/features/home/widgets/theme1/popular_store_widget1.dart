        ...
        children: [
          ...
          SizedBox(
            ...
            child: restaurant != null
              ...
              itemCount: restaurant.length, // No limit on number of restaurants
              options: CarouselOptions(
                autoPlay: true,
                enlargeCenterPage: false,
                height: 150,
                viewportFraction: 1 / 3, // Adjust for multiple items in view
                                  ...
                                  return InkWell(
                                    onTap: () {
                                      if (Get.find<AuthController>().isLoggedIn()) {
                                        isWished
                                            ? favouriteController.removeFromFavouriteList(restaurant[index].id, true)
