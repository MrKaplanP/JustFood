...
import 'package:justfood_multivendor/features/home/widgets/restaurants_card_widget.dart';
...
class WebNewOnStackFoodViewWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<RestaurantController>(builder: (restController) {
      return (restController.latestRestaurantList != null && restController.latestRestaurantList!.isEmpty)
          ? const SizedBox()
          : Padding(
            ...
            children: [
              ...
              restController.latestRestaurantList != null
                ...
                options: CarouselOptions(
                  height: 180,
                  autoPlay: true,
                  enableInfiniteScroll: restController.latestRestaurantList!.length > 1, // Disable infinite scroll if only one item
                  viewportFraction: 0.33, // Adjust to show 3 items at once like grid
                  enlargeCenterPage: false,
                  autoPlayInterval: const Duration(seconds: 2),
                ),
                itemCount: restController.latestRestaurantList!.length > 6
                    ? 6
