                      ...
                      children: [
                        ...
                        ArrowIconButtonWidget(onTap: () {
                          Get.toNamed(RouteHelper
                              .getAllRestaurantRoute(isRecentlyViewed
                              ? 'recently_viewed'
                              : 'popular'));
                        }),
                      ]),
                ...
                restaurantList != null
                  ...
                  child: CarouselSlider.builder(
                    ...
                    options: CarouselOptions(
                      autoPlay: true,
                      height: 185,
                      viewportFraction: 1/4, // Adjust as needed
                    ...
                    itemBuilder: (context, index, realIndex) {
                      ...
                      if (restaurantList[index].characteristics != null) {
                        for (var v
                        in restaurantList[index].characteristics!) {
                          characteristics =
                              ...
                              children: [
                                ...
                                Positioned(
                                  ...
                                  child: Container(
                                    ...
                                    child: Center(
                                      child: Text(
                                        '${restController.getRestaurantDistance(LatLng(double.parse(restaurantList[index].latitude!), double.parse(restaurantList[index].longitude!))).toStringAsFixed(2)} ${'km'.tr}',
                                        style: robotoMedium.copyWith(
                                            fontSize: Dimensions
                                                .fontSizeSmall,
                                            color: Theme.of(context)
