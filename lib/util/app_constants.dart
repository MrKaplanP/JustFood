import 'package:justfood_multivendor/features/language/domain/models/language_model.dart';
import 'package:justfood_multivendor/util/images.dart';
import 'package:get/get.dart';

class AppConstants {
  static const String appName = 'JustFood';
  static const double appVersion = 7.8;

  static const String fontFamily = 'Roboto';
  static const bool payInWevView = false;
  static const String webHostedUrl = 'https://justfood.gr';
  static const bool useReactWebsite = false;

  static const String baseUrl = 'https://admin.justfood.gr';
  ...
  /// Deep Links
  static const String yourScheme = 'JustFood';
  static const String yourHost = 'justfood.gr';

  /// Languages
  static List<LanguageModel> languages = [
    LanguageModel(imageUrl: Images.greek, languageName: 'Greek', countryCode: 'GR', languageCode: 'gr'),
